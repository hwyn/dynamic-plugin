...
export declare const builderPackage: (baseName: string, parent?: BuilderContext) => {
    ...
    UIElement: <T = any>(this: unknown, ...args: any[]) => (cls: Type<T>) => any;
