...
exports.ForwardElementExtension = void 0;
...
var builder_def_1 = require("../../hoc/forward-builder/builder-def");
var forward_builder_1 = require("../../hoc/forward-builder/forward-builder");
var ELEMENT = 'element';
var ForwardElementExtension = /** @class */ (function (_super) {
    tslib_1.__extends(ForwardElementExtension, _super);
    function ForwardElementExtension() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.engine = _this.injector.get(builder_1.BuilderEngine);
        return _this;
    }
    ...
    ForwardElementExtension.prototype.transform = function (builderField, element) {
        var _a;
        var _element = element ? (_a = (0, forward_builder_1.getComponentDef)(element)) !== null && _a !== void 0 ? _a : element : element;
        if (!(_element instanceof builder_def_1.BuilderDef))
            return _element;
        ...
        return this.engine.getUiComponent(ui_element_consts_1.BUILDER);
    };
